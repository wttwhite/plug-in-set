...
export function render (props, store, routes, handleRoute, instance, App, Vue, VueRouter) {
  let router = null
  let newRoute = []
...
export function mountFun (props, store, routes, handleRoute, instance, App, Vue, VueRouter) {
  console.log('[vue] props from main framework', props)
  if (!window.__POWERED_BY_QIANKUN__) {
    instance = render({ container: null }, store, routes, handleRoute, instance, App, Vue, VueRouter)
  }
